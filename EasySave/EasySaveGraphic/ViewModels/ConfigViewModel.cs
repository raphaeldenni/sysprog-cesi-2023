...
namespace EasySaveGraphic.ViewModels
{
    internal class ConfigViewModel
    {
        ...
        public void UpdateConfigFile(LogType? logExtension, LangType? lang, string? key, string[] extensions, string[] jobApplications, string[] extensionsPriority)
        {
            ConfigModel.UpdateConfigFile(logExtension, lang, key, extensions, jobApplications, extensionsPriority);
        }
    }
}
